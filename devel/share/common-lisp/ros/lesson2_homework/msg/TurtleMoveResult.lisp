...
(cl:defmethod cl:initialize-instance :after ((m <TurtleMoveResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurtleMoveResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lesson2_homework-msg:<TurtleMoveResult> is deprecated: use lesson2_homework-msg:TurtleMoveResult instead.")))

(cl:ensure-generic-function 'turtle_final_x-val :lambda-list '(m))
(cl:defmethod turtle_final_x-val ((m <TurtleMoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lesson2_homework-msg:turtle_final_x-val is deprecated.  Use lesson2_homework-msg:turtle_final_x instead.")
  (turtle_final_x m))

(cl:ensure-generic-function 'turtle_final_y-val :lambda-list '(m))
(cl:defmethod turtle_final_y-val ((m <TurtleMoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lesson2_homework-msg:turtle_final_y-val is deprecated.  Use lesson2_homework-msg:turtle_final_y instead.")
  (turtle_final_y m))

(cl:ensure-generic-function 'turtle_final_theta-val :lambda-list '(m))
(cl:defmethod turtle_final_theta-val ((m <TurtleMoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lesson2_homework-msg:turtle_final_theta-val is deprecated.  Use lesson2_homework-msg:turtle_final_theta instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurtleMoveResult>)))
  ...
  "lesson2_homework/TurtleMoveResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurtleMoveResult)))
  "Returns string type for a message object of type 'TurtleMoveResult"
  "lesson2_homework/TurtleMoveResult")
